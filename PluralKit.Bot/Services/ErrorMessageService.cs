    ...
    public class ErrorMessageService
    {
        ...
        public async Task SendErrorMessage(DiscordChannel channel, string errorId)
        {
            ...
            var embed = new DiscordEmbedBuilder()
                ...
                .WithDescription("For support, please send the error code above in **#bug-reports-** on **[the support server *(click to join)*](https://discord.gg/NMcsKRvpns)** with a screenshot of what you were doing at the time.")
                .WithFooter(errorId)
