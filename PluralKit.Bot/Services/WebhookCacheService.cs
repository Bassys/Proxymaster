...
namespace PluralKit.Bot
{
    ...
    {
        public static readonly string WebhookName = "Proxymaster Proxy Webhook";
        ...
        private async Task<DiscordWebhook> GetOrCreateWebhook(DiscordChannel channel)
        {
            ...
            if (webhooks.Count >= 10)
                throw new PKError("This channel has the maximum amount of possible webhooks (10) already created. A server admin must delete one or more webhooks so Proxymaster can create one for proxying.");
